...
social_filter_params = [
    ...
    'VETERAN STATUS', 'RESIDENCE 1 YEAR AGO', 'PLACE OF BIRTH',
    'US CITIZENSHIP STATUS', 'YEAR OF ENTRY', 'WORLD REGION OF BIRTH OF FOREIGN BORN',
    'LANGUAGE SPOKEN AT HOME', 'ANCESTRY', 'COMPUTERS AND INTERNET USE', 
]

# Process the filter parameters and create filtered dataframes
process_filter_params(normalized_df, social_filter_params)

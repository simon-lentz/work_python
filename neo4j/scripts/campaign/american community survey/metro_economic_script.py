...
economic_filter_params = [
    'EMPLOYMENT STATUS', 'COMMUTING TO WORK', 'OCCUPATION', 
    'INCOME AND BENEFITS IN 2021 INFLATION ADJUSTED DOLLARS', 
    'HEALTH INSURANCE COVERAGE', 'INDUSTRY', 'CLASS OF WORKER', 
    'PERCENTAGE OF FAMILIES AND PEOPLE WHOSE INCOME IN THE PAST 12 MONTHS IS BELOW THE POVERTY LEVEL'
]

# Process the filter parameters and create filtered dataframes
process_filter_params(normalized_df, economic_filter_params)
